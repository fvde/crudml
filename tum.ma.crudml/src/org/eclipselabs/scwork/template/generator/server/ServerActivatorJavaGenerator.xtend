...
class ServerActivatorJavaGenerator implements ITextFileGenerator {
	...
	override provideFile(InputParam param) {
		param.serverSourceFile(#["Activator.java"])
	}
...
public class Activator extends Plugin {
  ...
  public static String PLUGIN_ID = "«param.serverProjectName»";
  // The shared instance
