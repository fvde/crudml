...
class SwtDevSwtProductGenerator implements ITextFileGenerator {
	...
	override provideFile(InputParam param) {
		param.uiswtFile(#["products", "development", param.projectAlias + "-swt-client-dev.product"])
	}
...
<product name="«param.projectAlias»" id="«param.uiswtProjectName».product" application="«param.uiswtProjectName».application" useFeatures="false" includeLaunchers="true">
   ...
   <configIni use="default">
      <linux>/«param.uiswtProjectName»/products/development/config.ini</linux>
      <macosx>/«param.uiswtProjectName»/products/development/config.ini</macosx>
      <win32>/«param.uiswtProjectName»/products/development/config.ini</win32>
   </configIni>
