...
class RapProdRapProductGenerator implements ITextFileGenerator {
	...
	override provideFile(InputParam param) {
		param.uirapFile(#["products", "production", param.projectAlias + "-rap.product"])
	}
...
<product name="«param.projectAlias»" id="«param.uirapProjectName».product" application="«param.uirapProjectName».app" useFeatures="false" includeLaunchers="true">
   ...
   <configIni use="default">
      <linux>/«param.uirapProjectName»/products/production/config.ini</linux>
      <macosx>/«param.uirapProjectName»/products/production/config.ini</macosx>
      <solaris>/«param.uirapProjectName»/products/production/config.ini</solaris>
      <win32>/«param.uirapProjectName»/products/production/config.ini</win32>
   </configIni>
