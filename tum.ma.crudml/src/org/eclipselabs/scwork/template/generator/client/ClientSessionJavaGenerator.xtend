...
class ClientSessionJavaGenerator implements ITextFileGenerator {
	...
	override provideFile(InputParam param) {
		param.clientSourceFile(#["ClientSession.java"])
	}
...
import «param.clientProjectName».ui.desktop.Desktop;
...
public class ClientSession extends AbstractClientSession {
  ...
  public void execLoadSession() throws ProcessingException {
    ...
    CODES.getAllCodeTypes(«param.sharedProjectName».Activator.PLUGIN_ID);
