...
class MobileHomeFormJavaGenerator implements ITextFileGenerator {
	...
	override provideFile(InputParam param) {
		param.clientmobileSourceFile(#["ui", "forms", "MobileHomeForm.java"])
	}
...
import «param.clientmobileProjectName».ui.forms.MobileHomeForm.MainBox.LogoutButton;
import «param.clientmobileProjectName».ui.forms.MobileHomeForm.MainBox.OutlinesTableField;
