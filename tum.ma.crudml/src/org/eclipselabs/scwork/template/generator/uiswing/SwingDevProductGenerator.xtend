...
class SwingDevProductGenerator implements ITextFileGenerator {
	...
	override provideFile(InputParam param) {
		param.uiswingFile(#["products", "development", param.projectAlias + "-swing-client-dev.product"])
	}
...
<product name="«param.projectAlias» Client" id="«param.uiswingProjectName».product" application="«param.uiswingProjectName».app" useFeatures="false" includeLaunchers="true">
   ...
   <configIni use="default">
      <linux>/«param.uiswingProjectName»/products/development/config.ini</linux>
      <macosx>/«param.uiswingProjectName»/products/development/config.ini</macosx>
      <win32>/«param.uiswingProjectName»/products/development/config.ini</win32>
   </configIni>
